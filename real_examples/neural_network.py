...
def keras_prediction(training_ensemble, testing_inputs):
        ...
        # training_inputs        = training_inputs.as_matrix()
        training_target        = training_target.as_matrix()
        # testing_inputs         = testing_inputs.as_matrix()
        
        #----------------------------------
        # Scale the data
        #----------------------------------
        # scaler                 = preprocessing.RobustScaler().fit(training_inputs)
        # scaler                 = preprocessing.StandardScaler().fit(training_inputs)
        # scaler                 = preprocessing.MinMaxScaler(feature_range =(-1,1)).fit(training_inputs)
        # training_inputs_scaled = scaler.transform(training_inputs)
        # print training_inputs_scaled
        # training_inputs_scaled = training_inputs_scaled.replace(np.nan,0)
